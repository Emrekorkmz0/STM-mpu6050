...
{
    HAL_I2C_Mem_Write(&hi2c1, HMC5883L_DEFAULT_ADDRESS, reg, 1 ,value,1,500);
}
...
//    HAL_I2C_Mem_Write(&I2C, HMC5883L_ADDRESS, reg, 1 ,value,1,500)
    HAL_I2C_Mem_Read(&hi2c1,HMC5883L_DEFAULT_ADDRESS, reg, 1, &value, 1, 500);
    return value;
}
...
{
    int16_t value;
    HAL_I2C_Mem_Read(&hi2c1,HMC5883L_DEFAULT_ADDRESS, reg, 1, &value, 2, 500);
    return value;
}
